...
{
    public class STM32L4_RTC : IDoubleWordPeripheral, IKnownSize
    {
        public STM32L4_RTC(IMachine machine, long wakeupTimerFrequency = DefaultWakeupTimerFrequency)
        {
            ...
            var registerMap = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.ISR, new DoubleWordRegister(this, 0x7)
                    ...
                    .WithFlag(17, FieldMode.Read | FieldMode.WriteZeroToClear, name: "ITSF")                    
                    .WithIgnoredBits(18, 14) // We don't use reserved bits because the HAL sometimes writes 0s here and sometimes 1s
                },
        ...
        {
            public TimerConfig(STM32L4_RTC parent)
            {
                this.parent = parent;
            }
            ...
            private readonly STM32L4_RTC parent;
        }

        private class AlarmConfig
        {
            public AlarmConfig(STM32L4_RTC parent, TimerConfig masterTimer)
            {
                this.parent = parent;
